...
Once a `sections/tech.md` draft has been merged into the master, **never
...
An addendum goes in its own **round-scoped file**, `sections/tech_<round-id>.md`
and never `sections/tech.md`, and takes exactly this shape:

    # Technical design — <round id> addendum (tech-director)
